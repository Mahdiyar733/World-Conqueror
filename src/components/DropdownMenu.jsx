...
function DropdownMenu() {
	return (
		<div
			className={`flex flex-col p-6 gap-6 items-center rounded-lg backdrop-blur-lg backdrop-brightness-125 backdrop-hue-rotate-30 animate-fade animate-duration-200 w-full`}>
			<NavLink
				to="/"
				className={({ isActive }) =>
